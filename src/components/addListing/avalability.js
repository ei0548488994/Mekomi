...
function Availability()
{
    return(
        <>
         {/* Section */}
                            <div class="add-listing-section mt-45">
                      {/* Headline */}
                          ...
                          <div class="day-slots">
                            ...
                            <div class="slots-container">
                              ...
                              <div class="single-slot">
                                <div class="single-slot-left">
                                  <div class="single-slot-time">
                                    8:30 <i class="am-pm">am</i> - 9:00{" "}
                                    <i class="am-pm">am</i>
                                  </div>
                                  <button class="remove-slot">
                                    <i class="fa fa-close"></i>
